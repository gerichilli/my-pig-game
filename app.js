...
document.querySelector('.btn--roll').addEventListener('click', function() {
        if (gamePlaying) {// 1. Random number
            let diceFirst = generateRandomNumber(); //gọi giá trị cho xúc xắc thứ nhất
            let diceSecond = generateRandomNumber(); //gọi giá trị cho xúc xắc thứ hai
            let dice = diceFirst + diceSecond;
